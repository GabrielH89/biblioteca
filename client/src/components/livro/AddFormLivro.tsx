...
function AddFormLivro() {
    const [titulo, setTitulo] = useState("");
    const [autor, setAutor] = useState("");
    const [capa, setCapa] = useState<File | null>(null);  // Altere para File
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (capa) {
            formData.append("capa", capa);  // Adicionando a capa ao FormData
        }
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input
                        type="file"
                        onChange={handleFileChange}  // Função para capturar o arquivo
                        required
                    />
                </div>
                <div>
